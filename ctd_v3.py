            ...
            if not row[0].startswith('#'):
                ...
                for line in reader_row:
                    ...
                    if line[4]:
                        ...
                        # 疾病列表
                        disease_list = [line[3].replace('MESH:',''), line[2], DirectEvidence]
                        # 储存疾病信息
                        save_mysql(disease_list, 'disease', 'ctd_v2')
                        # 基因列表
                        gene_list = [line[1], line[0], DirectEvidence]
                        # 储存基因信息
                        save_mysql(gene_list, 'gene_primary', 'ctd_v2')
                        # 疾病和基因关系列表
                        gd_list = [line[3].replace('MESH:',''),line[1], DirectEvidence]
                        # 储存疾病和基因关系信息
                        save_mysql(gd_list, 'gd', 'ctd_v2')
